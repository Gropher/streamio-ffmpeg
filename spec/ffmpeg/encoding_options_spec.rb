  ...
  describe EncodingOptions do
    describe "ffmpeg arguments conversion" do
      ...
      it "should convert video codec" do
        EncodingOptions.new(video_codec: "libx264").to_s.should == "-c:v libx264"
      end
      ...
      it "should convert audio codec" do
        EncodingOptions.new(audio_codec: "aac").to_s.should == "-c:a aac"
      end
      ...
      it "should put the parameters in order of presets, others, codecs" do
        opts = Hash.new
        opts[:frame_rate] = 25
        ...
        converted.should == "-vpre normal -r 25 -c:v libx264"
      end
      ...
      it "should convert a lot of them simultaneously" do
        ...
        converted.should match(/-c:a aac/)
      end

      it "should ignore options with nil value" do
        EncodingOptions.new(video_codec: "libx264", frame_rate: nil).to_s.should == "-c:v libx264 "
      end
